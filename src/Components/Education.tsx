...
const formalEducationScreens = [
  ...
  },
  {
    ...
    description: `Selected as one of the 60 students in the college of engineering to receive this award for students with 
    outstanding achievements and engineering potential.`,
    image: mcmullen,
  },
  {
    title: 'Engineers in Action Project Team',
    description: `Engineers in Action builds a bridge annually with an underserved community to overcome a geographical 
    limitation. The engineering subteam designs and implements the bridge, along with educating the local community on 
    maintaining the structure.`,
    image: EIA,
  },
  {
    title: 'Student Manager at Visitor Relations',
    description: `Coordinated and scheduled a team of 80 tour guides while overseeing the daily operations of the Cornell 
    visitor's center.`,
    image: tg,
  },
  {
