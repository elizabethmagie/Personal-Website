...
const activities: Activity[] = [
  {
    title: 'Hiking',
    image: half_dome,
    description: `Hiking is one of my favorite ways to explore and experience nature. 
  ...
  },
  {
    title: 'Golfing',
    image: golf2,
    description: `Since graduating, I've become obsessed with golfing. It's taken up a lot of my time and money, but the satisfaction
  ...
  },
  {
    title: 'Skiing',
    image: ski2,
    description: `I’ve been an avid skier since childhood, one of the perks of growing up in California. I’ve loved experiencing the
  ...
  },
  {
    title: 'Travel',
    image: travel,
    description: `I love to travel. Experiencing new places and cultures makes me feel truly alive, and I prioritize it since
